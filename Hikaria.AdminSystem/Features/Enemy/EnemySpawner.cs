...
public class EnemySpawner : Feature
{
    ...
    private class EnemySync__OnSpawn__Patch
    {
        ...
        {
            if (spawnData.mode != AgentMode.Scout && spawnData.mode != AgentMode.Patrolling)
                return;
    ...
    private static void SpawnEnemy([EnemyDataBlockSuggestorTag] EnemyDataBlock block, int count = 1, AgentMode mode = AgentMode.Hibernate)
    {
